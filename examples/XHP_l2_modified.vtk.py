...
xHvtk = LegacyVTKReader(FileNames=['XHP_l2_modified.vtk'])
renderView1 = GetActiveViewOrCreate('RenderView')
xHvtkDisplay = Show(xHvtk, renderView1)
xHvtkDisplay.Representation = 'Surface'
renderView1.AxesGrid.Visibility = 1
xHvtkDisplay.Scale = [1, 9.48276e-05, 0.000578947]
renderView1.AxesGrid.DataScale = [1, 9.48276e-05, 0.000578947]
