...
xHvtk = LegacyVTKReader(FileNames=["XHP_l3_modified.vtk"])
renderView1 = GetActiveViewOrCreate("RenderView")
xHvtkDisplay = Show(xHvtk, renderView1)
xHvtkDisplay.Representation = "Surface"
renderView1.AxesGrid.Visibility = 1
xHvtkDisplay.Scale = [1, 9.91379e-05, 0.000589744]
renderView1.AxesGrid.DataScale = [1, 9.91379e-05, 0.000589744]
